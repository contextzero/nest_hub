# The NEST Enterprise License (the "Enterprise License")

Copyright (c) 2026-present Context Zero.

With regard to the NEST Software:

This software and associated documentation files (the "Software") may only be used in production, if
you (and any entity that you represent) hold a valid NEST Enterprise license corresponding to your
usage. Subject to the foregoing sentence, you are free to modify this Software and publish patches
to the Software. You agree that Context Zero and/or its licensors (as applicable) retain all right, title and
interest in and to all such modifications and/or patches, and all such modifications and/or patches
may only be used, copied, modified, displayed, distributed, or otherwise exploited with a valid NEST
...
agree that Context Zero and/or its licensors (as applicable) retain all right, title and interest in and to
...
For all third party components incorporated into the NEST Software, those components are licensed

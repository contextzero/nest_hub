...
NEST transforms how organizations deploy AI agents—shifting from isolated tools to a coordinated workforce operating from your infrastructure, visible on your phone, governed by your policies.

This document provides the strategic context for evaluating and adopting NEST.

---

## Why NEST? — First Principles Analysis

### The Problem (Current State)

| Stakeholder | Pain Point | Root Cause |
|-------------|------------|------------|
| **Founder/Admin** | No visibility into AI activity | Tools operate in silos |
...
| Stakeholder | Primary Benefit | Why It Matters |
|-------------|-----------------|----------------|
...
| Competitor | Their Weakness | NEST Advantage |
|------------|----------------|-----------------|
| **Zapier** | Rules-based automation | AI-native, learns, evolves |
| **Salesforce** | Sales-focused | Every employee, not just sales |
| **UiPath** | Rule-based RPA | AI-native, not rule-based |
| **GitHub Copilot** | Coding only | Full workforce, not just code |
| **Agentforce** | SaaS-only | Self-hosted option, full control |
...
|----------|----------|---------|
| [value-proposition.md](./value-proposition.md) | Founder, Admin | Detailed benefits breakdown |
| [use-cases.md](./use-cases.md) | All stakeholders | Real-world scenarios |
| [console-flow.md](./console-flow.md) | Employees | How requests become results |

### For Understanding Evolution

| Document | Content |
|-----------|---------|
| [phases.md](./phases.md) | Product phase roadmap |
| [../methodology/README.md](../methodology/README.md) | Implementation methodology |
